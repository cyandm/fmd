(() => {
  ...
  function getElementsFromOption2(option, legacySelector, parent = document) {
    ...
    if (option instanceof Element) {
      ...
      const selector3 = typeof option === "string" ? option : legacySelector;
      if (selector3) {
        elements = Array.from(parent.querySelectorAll(selector3));
      }
    }
    return elements;
  }
    ...
    "node_modules/photoswipe/dist/photoswipe.esm.js"() {
      ...
      PanBounds = class {
        ...
        correctPan(axis, panOffset) {
          return clamp3(panOffset, this.max[axis], this.min[axis]);
        }
      };
      ...
      Slide = class {
        ...
        zoomTo(destZoomLevel, centerPoint, transitionDuration, ignoreBounds) {
          ...
          if (!ignoreBounds) {
            destZoomLevel = clamp3(destZoomLevel, this.zoomLevels.min, this.zoomLevels.max);
          }
          ...
          this.pswp.animations.startSpring({
            ...
            onUpdate: (pos) => {
              if (restoreBgOpacity && this.pswp.bgOpacity < 1) {
                ...
                this.pswp.applyBgOpacity(clamp3(initialBgOpacity + (1 - initialBgOpacity) * animationProgressRatio, 0, 1));
              }
          ...
          pswp.animations.startSpring({
            ...
            onUpdate: (now2) => {
              ...
              if (restoreBgOpacity && pswp.bgOpacity < 1) {
                pswp.applyBgOpacity(clamp3(initialBgOpacity + (1 - initialBgOpacity) * now2, 0, 1));
              }
            },
            onComplete: () => {
              currSlide._setResolution(destinationZoomLevel);
      ...
      PhotoSwipe = class extends PhotoSwipeBase2 {
        ...
        getLoopedIndex(index) {
          ...
          return clamp3(index, 0, numSlides - 1);
        }
        appendHeavy() {
  ...
  var productCatCards = document.querySelectorAll(".product-cat-card");
  ...
  var tickerWrapperGroup = document.querySelectorAll(".ticker-wrapper");
  if (ticker) {
    setInterval(() => {
      ticker.scrollTo({
  ...
  var brandTickerGroup = document.querySelectorAll(".brand-ticker");
  var brandWrapperGroup = document.querySelectorAll(".brand-wrapper");
  if (brandTickerGroup) {
    ...
    headerTabs.forEach((headerTab, index) => {
      headerTab.addEventListener("click", (e) => {
        ...
        if (index !== 0) {
          ...
          contentTabsWrapper.style.borderTopLeftRadius = "26px";
          headerTabsWrapper.style.borderBottomLeftRadius = "26px";
        }
      });
    });
  ...
  var faq_ask = document.querySelectorAll(".question");
  var faq_answer = document.querySelectorAll(".answer");
  var faq_tab = document.querySelectorAll(".faq-tab");
  faq_ask == null ? void 0 : faq_ask.forEach((event2) => {
    event2.addEventListener("click", () => {
      event2.parentElement.classList.toggle("active");
    });
  });
  faq_tab == null ? void 0 : faq_tab.forEach((e) => {
  ...
  var lightboxProduct = new PhotoSwipeLightbox({
  ...
  var lightboxProductThumbnail = new PhotoSwipeLightbox({
    ...
    if (filterChips) {
      filterChips.forEach((el) => {
        el.addEventListener("click", (e) => {
          ...
          const checkInp = document.querySelector("input[name='".concat(dataFilter, "']"));
  ...
  primaryBtns.forEach((btn) => {
    ...
    btn.addEventListener("mouseenter", () => {
      ...
      btnTl.to(beforeEl, { scale: 35, duration: 1 }).to(afterEl, { scale: 35, duration: 1, delay: -0.5 });
    });
    btn.addEventListener("mouseleave", () => {
      btnTl.to(afterEl, { scale: 0, duration: 1 }).to(beforeEl, { scale: 0, duration: 1, delay: -0.5 });
    });
  });
