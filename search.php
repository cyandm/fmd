...
$productCats = $cynOptions->cyn_getProdactTerms(false, false, 'product-cat');
$brandsCats  = $cynOptions->cyn_getProdactTerms(false, false, 'brand');
$filtersCats = $cynOptions->cyn_getProdactTerms(false, false, 'filters');
  ...
  <div class="product-container">
    ...
    <?php if ($searchWpQuery->have_posts()) : ?>
      ...
      <div class="product-wrapper">
        <?php while ($searchWpQuery->have_posts()) : $searchWpQuery->the_post(); ?>
          <?php
